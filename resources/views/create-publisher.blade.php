...
<div class="container-fluid ms-2 mt-3">
    <div class="row">
        <h2>Tambahkan Data Publisher</h2>
    </div>
    <div class="row mt-3">
        <div class="col-8">
                ...
                <div class="card-body">
                    <form action="" method="post">
                        <div>
                            ...
                            <input type="text" name="nama_publisher" id="nama_publisher" class="form-control mb-3" placeholder="masukan nama publisher" required autocomplete="off">
                        </div>
                        <div>
                            <label for="nama_pendiri" class="form-label">Nama Pendiri</label>
                            <input type="text" name="nama_pendiri" id="nama_pendiri" class="form-control mb-3" placeholder="masukan nama pendiri" autocomplete="off">
                        </div>
                        <div>
                            <label for="tgl_didirikan" class="form-label">Tanggal Didirikan</label>
                            <input type="date" name="tgl_didirikan" id="tgl_didirikan" class="form-control mb-3" autocomplete>
                        </div>
                        <div>
                            <label for="kantor_pusat" class="form-label">Kantor Pusat</label>
                            <input type="text" name="kantor_pusat" id="kantor_pusat" class="form-control mb-3" placeholder="masukan alamat kantor pusat" autocomplete="off">
                        </div>
                        <div class="">
